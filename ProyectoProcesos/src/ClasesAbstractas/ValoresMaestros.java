...
public class ValoresMaestros {
	...
	public final static String COLUMNAS_MATRIZ_VENTAS[]= {"ID","NOMBRE DEL CLIENTE","CEDULA CLIENTE","NUM SOLICITUD CREDITO","PLAN POSPAGO","VALOR DE LA VENTA","ESTADO DE LA VENTA","CELULAR 1 CLIENTE","CORREO CLIENTE","ASESOR","SUPERVISOR"};
